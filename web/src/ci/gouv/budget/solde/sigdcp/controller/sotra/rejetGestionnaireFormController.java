...
@Named @ViewScoped
public class rejetGestionnaireFormController extends AbstractEntityFormUIController<DelegueSotra> implements Serializable {
	...
	public void initialisation() {
		...
		title = "Rejet de candidature de gestionnaire";
		internalCode = "FS_Sotra_02_Ecran_02_02";
