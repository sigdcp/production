...
@Named @ViewScoped
public class PrendreEnChargeBordereauController extends AbstractValidationBordereauTransmissionController implements Serializable {
	...
	protected String natureOperationCode() {
		return Code.NATURE_OPERATION_PRISE_EN_CHARGE;
	}
